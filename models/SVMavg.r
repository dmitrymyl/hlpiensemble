...
#kmer_AC.pred.raw <- predict(kmer_AC.Fit, newdata=kmer_AC, type = "raw")
kmer_AC.pred.prob <- predict(kmer_AC.Fit, newdata=kmer_AC, type = "prob")
#kmer_PseAACGeneral.pred.raw <- predict(kmer_PseAACGeneral.Fit, newdata=kmer_PseAACGeneral, type = "raw")
kmer_PseAACGeneral.pred.prob <- predict(kmer_PseAACGeneral.Fit, newdata=kmer_PseAACGeneral, type = "prob")
#DAC_kmer.pred.raw <- predict(DAC_kmer.Fit, newdata=DAC_kmer, type = "raw")
DAC_kmer.pred.prob <- predict(DAC_kmer.Fit, newdata=DAC_kmer, type = "prob")
#DAC_AC.pred.raw <- predict(DAC_AC.Fit, newdata=DAC_AC, type = "raw")
DAC_AC.pred.prob <- predict(DAC_AC.Fit, newdata=DAC_AC, type = "prob")
#DAC_PseAACGeneral.pred.raw <- predict(DAC_PseAACGeneral.Fit, newdata=DAC_PseAACGeneral, type = "raw")
DAC_PseAACGeneral.pred.prob <- predict(DAC_PseAACGeneral.Fit, newdata=DAC_PseAACGeneral, type = "prob")
#PCPseDNCGeneral_kmer.pred.raw <- predict(PCPseDNCGeneral_kmer.Fit, newdata=PCPseDNCGeneral_kmer, type = "raw")
PCPseDNCGeneral_kmer.pred.prob <- predict(PCPseDNCGeneral_kmer.Fit, newdata=PCPseDNCGeneral_kmer, type = "prob")
#PCPseDNCGeneral_AC.pred.raw <- predict(PCPseDNCGeneral_AC.Fit, newdata=PCPseDNCGeneral_AC, type = "raw")
PCPseDNCGeneral_AC.pred.prob <- predict(PCPseDNCGeneral_AC.Fit, newdata=PCPseDNCGeneral_AC, type = "prob")
...
names(pred.result)<-c("lncRNA","protein","SVM")
write.csv(pred.result,file="SVMavg.csv")